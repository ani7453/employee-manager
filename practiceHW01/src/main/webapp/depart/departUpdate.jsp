...
<body>
	...
	<div class="center">
		...
		<a href="./departUpdate.jsp" class="dark">Update Department</a>
	...
	<div class="center" style="height:50px; margin-top:10px; backgound-color:white;">
		<form action="../ConDepartUpdate" name="" method="post">
			Department ID: <input type="text" id="dpartId" name="dpartId"/>
